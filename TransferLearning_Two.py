...
print(gpus)
#%%
data_dir = os.path.join(r'C:\Users\user\Desktop\Python_Script\CNN\output')
...
model_name = "model_{epoch:03d}-{val_binary_accuracy:.3f}.h5"
# 若目錄不存在，則建立目錄
...
model_checkpoint = ModelCheckpoint(
    ...
    monitor='val_binary_accuracy',  # 監控驗證集的準確度
...
# =============================================================================
# 將儲存的檢查點調用
# model.load_weights(r'C:\Users\user\Desktop\Python_Script\CNN\Models\model_018-0.820.h5') #檔案名稱修改成想要的
# =============================================================================
#%% 繼續訓練
epochs = 30
