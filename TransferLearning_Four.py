...
#%%
data_dir = os.path.join(r'C:\Users\user\Desktop\Python_Script\CNN\cats_and_dogs_and_Eardrums')
...
for images, labels in validation_dataset:
    ...
    y_pred_probs.extend(tf.nn.softmax(model(images)).numpy())
...
P = model.predict(validation_dataset).flatten()
P = tf.nn.sigmoid(P)
